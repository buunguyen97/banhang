                    ...
                    <div class="p-20">
                        <form class="form-horizontal" role="form" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="text" name="TenL" id="TenL" class="form-control"
                                           value="<?= $kq['TenLoai'] ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="text" name="urlHinh" id="urlHinh" class="form-control"
                                           ...
                                           value="<?= $kq['hinh'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-2 col-form-label">ẨN Hiện: </label>
                                <div class="col-10">
                                    <input type="radio" id="AH1" name="anhien"
                                           value="1" <?= ($kq['AnHien'] == 1) ? "checked" : ""; ?>>
                                    <label for="AH1">Hiện&nbsp;&nbsp;&nbsp;</label>
                                    <input type="radio" id="AH0" name="anhien"
                                           value="0" <?= ($kq['AnHien'] == 0) ? "checked" : ""; ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="text" name="ThuTu" id="ThuTu" class="form-control"
                                           value="<?= $kq['ThuTu'] ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                    <button type="submit" class="btn btn-primary m-t-15 waves-effect">THÊM Loại SP
                                    </button>
                                </div>
                            </div>
