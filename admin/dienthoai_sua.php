...
if (isset($_POST['TenDT'])) {
    ...
    $qt->capnhatDT($TenDT,$urlhinh,$AnHien,$Hot,$Mota,$datepicker,$idL,$idCL,$gia,$giaKM,$tonkho,$LanBan,$NoiDung,$LanXem,$idDT);
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="m-t-0 header-title">SỬA Nội Dung Điện Thoại</h4>
                    ...
                    <div class="p-20">
                        <form class="form-horizontal" role="form" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="text" name="TenDT" id="TenDT" class="form-control" value="<?=$kq['TenDT']?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="text" name="urlHinh" id="urlHinh" class="form-control"
                                           onclick="selectFileWithCKFinder('urlHinh')" placeholder="" value="<?=$kq['urlHinh']?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="radio" id="AH1" name="hot" <?=($kq['Hot']==1)?"checked":"";?> value="1">
                                    <label for="AH1">Có</label>
                                    <input type="radio" id="AH0" name="hot"<?=($kq['Hot']==0)?"checked":"";?> value="0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <textarea type="text" name="Mota" id="Mota" class="form-control" ><?=$kq['MoTa']?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-3">
                                    <select class="form-control btn btn-primary " name="idL" id="idL">
                                        ...
                                        while ($row = $ListL->fetch_assoc()) { ?>
                                            <?php if($row['idLoai']==$kq['idLoai']){ ?>
                                                <option value="<?= $kq['idLoai'] ?>" selected><?= $row['TenLoai'] ?></option>
                                                <?php }else{ ?>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-2">
                                    <input type="number" name="gia" id="gia" class="form-control" value="<?=$kq['Gia']?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-2 col-form-label">Giá KM</label>
                                <div class="col-2">
                                    <input type="number" name="giakm" id="giakm" class="form-control" value="<?=$kq['GiaKM']?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-2 col-form-label">Số Lượng Trong Kho</label>
                                <div class="col-1">
                                    <input type="number" name="tonkho" id="tonkho" class="form-control" value="<?=$kq['SoLuongTonKho']?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-2 col-form-label">Số Lượng Bán</label>
                                <div class="col-1">
                                    <input type="number" name="lanban" id="lanban" class="form-control" value="<?=$kq['SoLanMua']?>"    required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-2 col-form-label">Số Lần Xem</label>
                                <div class="col-1">
                                    <input type="number" name="lanxem" id="lanxem" class="form-control" value="<?=$kq['SoLanXem']?>"  required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <textarea id="elm1" name="noidung"><?=$kq['baiviet']?></textarea>
